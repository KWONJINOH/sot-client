# Contributing to sot-client

We would love for you to contribute to sot-client and help make it ever better together! :rocket:
...
Help us keep sot-client open and inclusive. Please read and follow our [Code of Conduct][coc].

## <a name="question"></a> Got a Question or Problem?

Please do not open issues for general support questions as we want to keep GitHub issues for bug reports and feature requests. You've got much better chances of getting your question answered on [StackOverflow][stackoverflow] where the questions should be tagged with tag `sot-client`.
...
* If you have a question about using sot-client, please ask on the [StackOverflow][stackoverflow].
...
* In GitHub, send a pull request to `sot-client:master`.
...
we use the git commit messages to **generate the sot-client change log**.
...
[dev-doc]: DEV_DOCS.md
[github]: https://github.com/akveo/sot-client
[stackoverflow]: https://stackoverflow.com/questions/tagged/sot-client
[issues]: https://github.com/akveo/sot-client/issues
[new_issue]: https://github.com/akveo/sot-client/issues/new
[pulls]: https://github.com/akveo/sot-client/pulls
